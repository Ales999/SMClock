...
{
    public interface IPlayWavFile : IDisposable
    {
        /// <summary>
        /// Синхронно проиграть файл
        /// </summary>
        void Play();

        /// <summary>
        /// Асинхронно проиграть файл
        /// </summary>
        /// <returns></returns>
        Task PlayAsync();

        /// <summary>
        /// Загрузить другой файл для проигрывания
        /// </summary>
        /// <param name="fileName"></param>
        void SetNewPlayFile(string fileName);
    }
}
