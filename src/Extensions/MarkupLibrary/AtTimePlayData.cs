...
{
    public class AtTimePlayData : IAtTimePlayData
    {
        public string FileNameToPlay { get; set; }
        public List<string> TsLists { get; set; }

        public AtTimePlayData(string fileNameToPlay, List<string> tsLists)
        {
            this.FileNameToPlay = fileNameToPlay;
            this.TsLists = tsLists;
        }
    }
}
