...
namespace MarkupLibrary
{
    ...
    public class MarkupLibraryRegistry : Registry
    {
        public MarkupLibraryRegistry()
        {
            For<IOfMark>().Use<OfMark>();
            For<ISetOfMark>().Use<SetOfMark>();

            For<IAtTimePlayData>().Use<AtTimePlayData>();
            For<IAtTimePlayDataMsg>().Use<AtTimePlayDataMsg>();
        }
    }
}
