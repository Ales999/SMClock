...
namespace AppConfigLibrary
{
    ...
    /// <summary>
    /// Объект для передачи в виде сообщения
    /// </summary>
    public class AppAutoStartMsg : IAppAutoStartMsg
    {
        private bool _usingAutoStart;
        private string _appName;

        public bool UsingAutoStart
        {
            get { return _usingAutoStart; }
            set { _usingAutoStart = value; }
        }
        ...
        public AppAutoStartMsg(bool usingAutoStart, string appName)
        {
            _usingAutoStart = usingAutoStart;
            _appName = appName;
        }
    }
}
