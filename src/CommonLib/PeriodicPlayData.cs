...
namespace CommonLib
{
    public class PeriodicPlayData : IPeriodicPlayData
    {
        public PeriodicPlayData(int everyMinut, string fileName)
        {
            EveryMinut = everyMinut;
            FileName = fileName;
        }

        public int EveryMinut { get; set; }
