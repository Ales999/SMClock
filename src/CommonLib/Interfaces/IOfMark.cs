...
{
    /// <summary>
    /// Интерфейс пары Час:Минута
    /// </summary>
    public interface IOfMark
    {
        /// <summary>
        /// Час временной отметки
        /// </summary>
        int MarkHour { get; set; }

        /// <summary>
        /// Минута временной отметки
        /// </summary>
        int MarkMinute { get; set; }

        /// <summary>
        /// Вернуть пару в виде HH:MM
        /// </summary>
        /// <returns></returns>
        string GetString();
    }
