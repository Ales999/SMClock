...
namespace CommonLib.Interfaces
{
    ...
    /// Набор отметок
    /// </summary>
    public interface ISetOfMark
    {
        /// <summary>
        /// Наименование набора временных отметок
        /// </summary>
        string NameOfSet { get; set; }

        /// <summary>
        /// Список пар отметок вида Час:Минута
        /// </summary>
        List<IOfMark> OfMarkList { get; set; }
    }
}
