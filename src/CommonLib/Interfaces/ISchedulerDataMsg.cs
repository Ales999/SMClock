...
namespace CommonLib.Interfaces
{
    ...
    /// <summary>
    /// Объединенный интерфейс для обоих типов шедулера
    /// </summary>
    public interface ISchedulerDataMsg 
    {
        /// <summary>
        /// Для передачи переодичесский проигрываний
        /// </summary>
        IPeriodicPlayData PrMessage { get; set; }

        /// <summary>
        /// Для передачи данный для указанных точно в какое время проигрывать
        /// </summary>
        IAtTimePlayData   AtMessage { get; set; }
    }
}
