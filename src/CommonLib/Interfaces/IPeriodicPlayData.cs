...
{
    /// <summary>
    /// Интерфейс описывающий структуру передачи данных
    /// для периодичесского проигрывания файла
    /// </summary>
    public interface IPeriodicPlayData
    {
        /// <summary>
        /// Через какой промежуток, в минутах,
        /// проирывать файл
        /// </summary>
        int EveryMinut { get; set; }

        /// <summary>
        /// Путь и имя файла которое нужно проиграть
        /// </summary>
