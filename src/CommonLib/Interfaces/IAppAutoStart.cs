...
{
    /// <summary>
    /// Интерфейс для AutoStartup application
    /// </summary>
    public interface IAppAutoStart
    {
        /// <summary>
        /// Проверка что уже есть запись для авто-старта
        /// </summary>
        /// <param name="appName"></param>
        /// <returns></returns>
        bool IsStartup(string appName);

        /// <summary>
        /// Добавить программу в автостарт
        /// </summary>
        /// <param name="appName"></param>
        /// <returns></returns>
        bool AddToAutoStarup(string appName);

        /// <summary>
        ///  Удалить программу из автостарта.
        /// </summary>
        /// <param name="appName"></param>
        /// <returns></returns>
        bool RemoveFromAutoStartup(string appName);
    }
}
