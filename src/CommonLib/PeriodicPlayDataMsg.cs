...
namespace CommonLib
{
    public class PeriodicPlayDataMsg : IPeriodicPlayDataMsg
    {
        public PeriodicPlayDataMsg(IPeriodicPlayData periodicPlayData)
        {
            Message = periodicPlayData;
        }
        public IPeriodicPlayData Message { get; set; }
    }
}
