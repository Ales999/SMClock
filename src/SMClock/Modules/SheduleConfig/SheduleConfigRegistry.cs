...
using SMClock.Modules.SheduleConfig.ViewModels;

namespace SMClock.Modules.SheduleConfig
{
    using StructureMap;

    /// <summary>
    /// Регистрация компонента конфигурации шедулера
    /// </summary>
    public class SheduleConfigRegistry : Registry
    {
        public SheduleConfigRegistry()
        {
            For<ISheduleConfig>().Use<SheduleConfigViewModel>().Singleton();
        }
    }
}
