...
using SMClock.Modules.TrayIcon.ViewModels;

namespace SMClock.Modules.TrayIcon
{

    using StructureMap;

    class SystemTrayIconRegistry : Registry
    {
        public SystemTrayIconRegistry()
        {
            /*
            this.Scan(s =>
            {
            ...
            */
            ...
            For<ISystemTrayIcon>().Use<SystemTrayIconViewModel>().Singleton();
        }
    }
}
